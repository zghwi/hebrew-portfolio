  ...
  return (
    <div className="relative">
      ...
      <div className="flex-1 ml-auto pr-0 pt-20 mt-16">
        ...
        <p>בתיק הזה אספתי עבודות, חיבורים, משימות, וסרטונים שיצרתי – כל אלו משקפים את הדרך שעברתי.</p><br/>
        <p>
          <b>מטרות התלקיט:</b>
          <ul>
            <li>
              - להציג את תהליך הלמידה שלי בעברית לאורך השנתיים האחרונות, כולל ההתקדמות והאתגרים שהתמודדתי איתם.
            </li>
            <li>
              - לאסוף ולתעד משימות, חיבורים, תרגולים וסרטונים המראים את ההתפתחות שלי לאורך הדרך.
            </li>
            <li>
              - לרכוש כלים שישמשו אותי בהמשך בלימודים ובחיים המקצועיים.
            </li>
            <li>
              - ללמוד מהטעויות, להבין את נקודות החוזק והחולשה שלי, ולמצוא דרכים להשתפר.
            </li>
          </ul>
        </p>
        </Section>
...
<p>בהתחלה, היה לי לא קל לארגן את המחשבות שלי ולהביע אותן בצורה מסודרת, אבל עם הזמן למדתי כיצד לבנות חיבור בצורה נכונה לפי סוג החיבור. המשימה הזו גם שיפרה את היכולת שלי להביע דעה בכתב בעברית, ולחזק את הביטחון שלי בכתיבה.</p>
        ...
        <Section id="exams" title="דוגמאות לבחינות">
          <Gallery />
        </Section>
